	...
	<div id="page-wrapper">
		...
		<header id="header">
			<div class="logo container">
				<div>
					<h1>
						<a href="index.html" id="logo">게시글</a>
					</h1>
				</div>
			</div>
		</header>
					...
					<div class="col-12">
						<div class="content">
							...
							<article class="box page-content">
								...
								<header>
									...
									<ul class="meta">
										...
										<c:if test="${not empty mid}">
											...
											<li><i id="ph" class="icon solid fa-ban" title="신고"></i>${bdata.prohibitCnt}</li> 
										</c:if>
								...
								<c:if test="${mid eq bdata.mid}">
									<section id="updatepagebutton">
										<form action="updateBoardPage.do">
											<input type="hidden" name="boardNum" value="${bdata.boardNum}">
								...
								<section id="insertCommentBox">
									<form id="insertComment" action="insertComment.do">
										<input type="hidden" name="boardNum" value="${bdata.boardNum}">
										<input type="text" name="comments" placeholder="댓글 작성 내용" required>
